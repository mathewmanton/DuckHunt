...
void OBJLoader::ReadMaterials(std::ifstream& fin, std::vector<M3dMaterial>& mats)
{
	//setup a default material
	M3dMaterial currMaterial;
...
UINT OBJLoader::GetSubset(const std::wstring& name, const std::vector<M3dMaterial>& mats)
{
	std::string strName;
